...
//---------- BEGIN MODULE SCOPE VARIABLES ----------
	...
	// Purpose		: Move the chat slider to the requested position_type
	// Arguments	: 
	//		* position_type - enum('closed', 'opened', or 'hidden')
	//		* callback - optional callback to be run at the end of slider
	//		  animation. The callback receives a jQuery collection representing
	//		  the slider div as its single argument.
	// Action		:
	// This method moves the slider into the requested position.
	// If the requested position is the currrent position, it returns
	...
	// 		HTML content. It then initialized elements, events, and handlers to
